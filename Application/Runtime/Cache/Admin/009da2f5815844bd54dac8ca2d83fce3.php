	...
	<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
						<span id="example4" href="assets/img/demoBig2.jpg" title="Cras neque mi, semper leon"><img src="/RealHome/Public/Uploads/<?php echo ($v["image"]); ?>" alt="" style='width:300px;height:200px'></span>
					</td>
