...
<html lang="en">
			...
			<div class="row-fluid">
				<ul class="ace-thumbnails">
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a href="/RealHome/Public/assets/images/gallery/image-1.jpg" title="Photo Title" data-rel="colorbox">
								<img alt="192x150" src="/RealHome/Public/Uploads/<?php echo ($vo["filename2"]); ?>" />
								<div class="tags">
	...
	<script src="/RealHome/Public/assets/js/jquery.colorbox-min.js"></script>
