...
<!-- 
 ...
 -->
    ...
    <link rel="stylesheet" href="/second_object_demo/Public/Home/css/order.css" />
    <!-- <link href="/second_object_demo/Public/Home/css/public_element.css" rel="stylesheet"> -->
    <link href="/second_object_demo/Public/Home/css/order_public.css" rel="stylesheet">
    <link href="/second_object_demo/Public/Home/css/index_list_calendar.css" rel="stylesheet" type="text/css">
    <link href="/second_object_demo/Public/Home/css/layer.css" rel="stylesheet" type="text/css">
    <link href="/second_object_demo/Public/Home/css/fdbx.css" rel="stylesheet">
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/jquery-1.9.1.min.js"></script>
    ...
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/c.js" ></script>  
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/ticket.js" ></script>
    <!--kgj add保险JS START-->
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/insurance.js"></script>
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/idcard.js"></script>
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/mayi.validate.js"></script>
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/maputil.js"></script>
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/usercontact.js"></script>
    <!--kgj add保险JS END-->
    <!--日历-->
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/yui-min.js" ></script>
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/index_list_calendar.js" ></script>
    
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/order.js"></script>
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/bookorder.js"></script>
    <!--右侧滚动效果-->
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/scroll_zi.js"></script>
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/scroll_zi.js"></script>
    <script type="text/javascript" src="/second_object_demo/Public/Home/js/util.js"></script>
...
<body>
    ...
    <!--header-->
<script type="text/javascript" src="/second_object_demo/Public/Home/js/index_searchlist_public.js"></script>
<script type="text/javascript" src="/second_object_demo/Public/Home/js/list_header.js"></script> 
<style>	
        ...
        <div class='fl content_left'>
                ...
                <div class='cnt1 clearfloat'>
                    ...
                    <div class='fl'>
                        ...
                        <dl class='cnt1_dl clearfloat'>
                            ...
                            <b class='fl room_pice relave'>房费&nbsp;¥233</strong>
            ...
            <div class='cnt1 cnt2 clearfloat'>
                ...
                <div class="fl">
                    <dl class='cnt1_dl clearfloat'>
                        <dt class='fl'>姓名</dt>
                        <dd class='fl'><input type="text" placeholder="选填" tabindex="2" value="" id="tenantname" name="tenantname" maxlength="20" onkeypress="cannotInputNumber(event, this)" onblur="checkIntegerNumber(event,this)" onkeyup="checkIntegerNumber(event,this)"/></dd>
                    </dl>
                    <dl class='cnt1_dl clearfloat'>
                        <dt class='fl'>手机号</dt>
                        <dd class='fl'>
        ...
        <div class="fr content_right  pin" id="pin1">
            <div class='right_cnt'>
                ...
                <div class='room_intro relave clearfloat'>
                        <img class="fl" src="picture/bfxu1ukypuliprb547iro556wnisio.jpg_200x140c.jpg"/>
                    <strong>[徐汇区]7/9/12号线肇嘉浜地铁站附近</strong>
