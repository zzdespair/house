		...
		<h3>房源基本信息</h3>
			<div class="col-md-9 single-box">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class=" col-sm-7 left-side ">
						<a href="single.html"> <img class="img-responsive" src="/second_object_demo/Public/Uploads/<?php echo ($v["filename3"]); ?>" alt=""></a>
					</div>				
					<div class="  col-sm-5 middle-side">
						...
						<div class="   right-side">
							 <a href="contact.html" class="hvr-sweep-to-right more" >查看详情</a>     
						 </div>
					 </div>
