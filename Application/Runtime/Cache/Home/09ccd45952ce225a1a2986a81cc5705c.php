...
<link href="/tp_rbac_demo/Public/Home/css/bootstrap.css" rel="stylesheet" type="text/css" media="all">
<link href="/tp_rbac_demo/Public/Home/css/style.css" rel="stylesheet" type="text/css" media="all" />
...
<script src="/tp_rbac_demo/Public/Home/js/jquery.min.js"></script>
...
<!-- header -->
	<div class="header">
		<div class="container">
			<div class="logo">
				<a href="index.html"><img src="/tp_rbac_demo/Public/Home/images/logo.png" class="img-responsive" alt=""></a>
			</div>
			<?php echo W('Nav/menu');?>
...
<link rel="stylesheet" type="text/css" href="/tp_rbac_demo/Public/Home/css/common.css" />
<!-- header -->
<!--start-about-->	
	<div class="about">
		<div class="container">
			<div class="about-main">
				...
				<div class="about-top">
					<div class="col-md-5 about-top-left">
						<img src="/tp_rbac_demo/Public/Home/images/abt-1.jpg" alt="">
					</div>
